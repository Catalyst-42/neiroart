...
def draw_side(x, y, side):
    ...
    def right_enter(): data[x+2, y-2:y], data[x+2, y+1:y+3] = colors_RGB['blue'], colors_RGB['blue'] # right enter
    def left_enter(): data[x-2, y-2:y], data[x-2, y+1:y+3] = colors_RGB['blue'], colors_RGB['blue'] # left enter
    def up_enter(): data[x-2:x, y+2], data[x+1:x+3, y+2] = colors_RGB['blue'], colors_RGB['blue'] # up enter
    def down_enter(): data[x-2:x, y-2], data[x+1:x+3, y-2] = colors_RGB['blue'], colors_RGB['blue'] # down enter
