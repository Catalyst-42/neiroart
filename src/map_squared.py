...
while len(working_stack):
    ...
    # right
    if data[x+4, y-1][0] != 21 and data[x+4, y][0] != 21: remove_sides(1, 2, 4, 8, 11, 12, 13, 15)
    elif data[x+4, y-1][0] != 21 and data[x+4, y][0] == 21: remove_sides(0, 3, 5, 6, 7, 9, 10, 14)

    # left
    if data[x-4, y-1][0] != 21 and data[x-4, y][0] != 21: remove_sides(1, 2, 6, 9, 10, 13, 14, 15)
    elif data[x-4, y-1][0] != 21 and data[x-4, y][0] == 21: remove_sides(0, 3, 4, 5, 7, 8, 11, 12)

    #  up
    if data[x-1, y+4][0] != 21 and data[x, y+4][0] != 21: remove_sides(1, 3, 5, 8, 9, 12, 13, 14)
    elif data[x-1, y+4][0] != 21 and data[x, y+4][0] == 21: remove_sides(0, 2, 4, 6, 7, 10, 11, 15)

    # down
    if data[x-1, y-4][0] != 21 and data[x, y-4][0] != 21: remove_sides(1, 3, 7, 10, 11, 12, 14, 15)
    elif data[x-1, y-4][0] != 21 and data[x, y-4][0] == 21: remove_sides(0, 2, 4, 5, 6, 8, 9, 13)
