...
def gen():
    ...
    LINE_LENGTH = CONSTANTS['LINE_LENGTH'][1]
    LINE_COLOR = CONSTANTS['LINE_COLOR'][1]

    BACKGROUND_COLOR = CONSTANTS['BACKGROUND_COLOR'][1]

    COLORED = CONSTANTS['COLORED'][1]
    COLOR_A = CONSTANTS['COLOR_A'][1]
    COLOR_B = CONSTANTS['COLOR_B'][1]

    EXCLUDE_CIRCLES = CONSTANTS['EXCLUDE_CIRCLES'][1]
    EXCLUDE_CROSSES = CONSTANTS['EXCLUDE_CROSSES'][1]
