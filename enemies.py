...
x, y = 11, 3
draw.rectangle((10, 2, 10+int((hp/max_hp)*36), 2+6), fill=tuple(red))
...
x, y = 11, 11
draw.rectangle((10, 10, 10+int((mana/max_mana)*36), 10+6), fill=tuple(blue))
...
image = image.resize((48*8, 24*8), resample=Image.BOX)
