...
def draw_side(x, y, side):
    ...
    if randint(1, 100) == 1:
        color = colors_RGB[choice(color_names)]

    def right_enter(): data[x:x+3, y] = color #colors_RGB['blue'] # right
    def left_enter(): data[x-2:x+1, y] = color #colors_RGB['blue'] # left
    def up_enter(): data[x, y:y+3] = color #colors_RGB['blue'] # up
    def down_enter(): data[x, y-2:y+1] = color #colors_RGB['blue'] # down
